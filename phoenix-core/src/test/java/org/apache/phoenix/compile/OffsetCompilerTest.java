...
public class OffsetCompilerTest {
    ...
    @Before
    public void init(){
        offsetCompiler = OffsetCompiler.getOffsetCompiler();
    }
    ...
    public void buildListOfRowKeyColumnExpressionsTest() throws Exception {
        ...
        Mockito.when(expression1.getChildren()).thenReturn(Lists.newArrayList(rvc1));
        Mockito.when(expression2.getChildren()).thenReturn(Lists.newArrayList(rvc2));
